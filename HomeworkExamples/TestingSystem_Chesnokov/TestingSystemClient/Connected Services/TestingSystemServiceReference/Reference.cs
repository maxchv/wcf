...
namespace TestingSystemClient.TestingSystemServiceReference {
    ...
    public partial class Test : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private TestingSystemClient.TestingSystemServiceReference.Question[] QuestionsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public TestingSystemClient.TestingSystemServiceReference.Question[] Questions {
            get {
    ...
    public partial class TestResult : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private TestingSystemClient.TestingSystemServiceReference.QuestionWithAnswer[] QuestionsField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private int RatingField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private TestingSystemClient.TestingSystemServiceReference.Test TestField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private TestingSystemClient.TestingSystemServiceReference.User UserField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public TestingSystemClient.TestingSystemServiceReference.QuestionWithAnswer[] Questions {
            get {
                return this.QuestionsField;
            }
            set {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public TestingSystemClient.TestingSystemServiceReference.Test Test {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public TestingSystemClient.TestingSystemServiceReference.User User {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="TestingSystemServiceReference.ITestingSystemService", CallbackContract=typeof(TestingSystemClient.TestingSystemServiceReference.ITestingSystemServiceCallback))]
    public interface ITestingSystemService {
        ...
        bool RegisterNewUser(TestingSystemClient.TestingSystemServiceReference.User user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITestingSystemService/RegisterNewUser", ReplyAction="http://tempuri.org/ITestingSystemService/RegisterNewUserResponse")]
        System.Threading.Tasks.Task<bool> RegisterNewUserAsync(TestingSystemClient.TestingSystemServiceReference.User user);
        ...
        void CreateNewTest(TestingSystemClient.TestingSystemServiceReference.Test test);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/ITestingSystemService/CreateNewTest")]
        System.Threading.Tasks.Task CreateNewTestAsync(TestingSystemClient.TestingSystemServiceReference.Test test);
        ...
        void StartTesting(TestingSystemClient.TestingSystemServiceReference.User user, string testId);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/ITestingSystemService/StartTesting")]
        System.Threading.Tasks.Task StartTestingAsync(TestingSystemClient.TestingSystemServiceReference.User user, string testId);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/ITestingSystemService/EndTesting")]
        void EndTesting(TestingSystemClient.TestingSystemServiceReference.TestResult result, string groupId, string subgroupId, string testId);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/ITestingSystemService/EndTesting")]
        System.Threading.Tasks.Task EndTestingAsync(TestingSystemClient.TestingSystemServiceReference.TestResult result, string groupId, string subgroupId, string testId);
    ...
    public interface ITestingSystemServiceCallback {
        ...
        void SetQuestions(TestingSystemClient.TestingSystemServiceReference.Question[] questions, string groupId, string subgroupId);
        ...
        void ResultOfUserSignIn(TestingSystemClient.TestingSystemServiceReference.User user, string message);
        ...
        void SetTestResults(TestingSystemClient.TestingSystemServiceReference.TestResult[] results);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ITestingSystemServiceChannel : TestingSystemClient.TestingSystemServiceReference.ITestingSystemService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class TestingSystemServiceClient : System.ServiceModel.DuplexClientBase<TestingSystemClient.TestingSystemServiceReference.ITestingSystemService>, TestingSystemClient.TestingSystemServiceReference.ITestingSystemService {
        ...
        public bool RegisterNewUser(TestingSystemClient.TestingSystemServiceReference.User user) {
            return base.Channel.RegisterNewUser(user);
        }
        
        public System.Threading.Tasks.Task<bool> RegisterNewUserAsync(TestingSystemClient.TestingSystemServiceReference.User user) {
        ...
        public void CreateNewTest(TestingSystemClient.TestingSystemServiceReference.Test test) {
            base.Channel.CreateNewTest(test);
        }
        
        public System.Threading.Tasks.Task CreateNewTestAsync(TestingSystemClient.TestingSystemServiceReference.Test test) {
        ...
        public void StartTesting(TestingSystemClient.TestingSystemServiceReference.User user, string testId) {
            base.Channel.StartTesting(user, testId);
        }
        
        public System.Threading.Tasks.Task StartTestingAsync(TestingSystemClient.TestingSystemServiceReference.User user, string testId) {
            return base.Channel.StartTestingAsync(user, testId);
        }
        
        public void EndTesting(TestingSystemClient.TestingSystemServiceReference.TestResult result, string groupId, string subgroupId, string testId) {
            base.Channel.EndTesting(result, groupId, subgroupId, testId);
        }
        
        public System.Threading.Tasks.Task EndTestingAsync(TestingSystemClient.TestingSystemServiceReference.TestResult result, string groupId, string subgroupId, string testId) {
